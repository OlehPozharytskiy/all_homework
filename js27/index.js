...
function showСomparisonNmber() {
  ...
  let result = document.querySelector("#result-task-1");
  result.textContent = compareNmber(firstNum, secondNum);
}

document.querySelector("#btn1").addEventListener("click", showСomparisonNmber);
...
document.querySelector("#btn2").addEventListener("click", showFactorial);
// end of task 2
...
document.querySelector("#btn3").addEventListener("click", showCreateNumber);
// end of task 3
...
document.querySelector("#btn4").addEventListener("click", showCalculateArea);
// end of task 4
...
document.querySelector("#btn5").addEventListener("click", showCheckNumber);
// end of task 5
...
document
  .querySelector("#btn6")
  .addEventListener("click", showCheckNumberFromRange);
// end of task 6
...
document.querySelector("#btn7").addEventListener("click", showTime);
// end of task 7
...
document.querySelector("#btn8").addEventListener("click", showConvertTime);
// end of task 8
...
document
  .querySelector("#btn9")
  .addEventListener("click", showConvertTimeFromSeconds);
// end of task 9
...
document.querySelector("#btn10").addEventListener("click", showCompareTime);
